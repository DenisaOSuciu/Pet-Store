 ...
 * @author denisasuciu
 */
public class question12 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Va deranjeaza parul lasat de animale?");

        yesBtn.setText("Da, ma deranjeaza");

        noBtn.setText("Nu ma deranjeaza");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(question12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new question12().setVisible(true);
            }
        });
    }
